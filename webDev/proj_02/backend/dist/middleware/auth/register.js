...
async function RegisterNewAccount(req, res) {
    try {
        ...
        const passwordStrength = (0, zxcvbn_1.default)(trimmedCreatePassword);
        ...
        // 4️⃣ Hash password
        const hashedPassword = await bcryptjs_1.default.hash(trimmedCreatePassword, 12);
        // 5️⃣ Generate JWT token
        const token = jsonwebtoken_1.default.sign({ username: trimmedUsername, emailOrPhone: trimmedEmailOrPhone }, process.env.JWT_SECRET || "supersecretkey", { expiresIn: "7d" });
